...
<span v-if="isloading">
  ...
  <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 pull-right">
  	<h3 class=""><span class="label label-default"><i class="fa fa-folder"></i> الخدمات الخاصه بقسم {{ cat.name}}</span></h3>
...
<br>
  ...
  <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 pull-left">
      <side_bar  :section1="section1" :section2="section2" :section3="section3"></side_bar>
   </div>
...
<script >
  ...
  import SideBar from '../pages/MainSideBar.vue' ;
...
var url = '/getServicesByCat/'+this.$route.params.cat_id+sendlen;
