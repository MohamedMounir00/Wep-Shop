<template>
  ...
  <div class="col-lg-12">
    ...
    <div v-if="isloading">
      ...
      <h3 class=""><span class="label label-default"><i class="fa fa-user"></i> طلبات الشراء الخاصه بالعضو{{ user.name}}</span></h3>
...
<div class="row ">
  ...
  <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2"><b>مقدم الخدمه</b></div>
...
<div v-if="services.length > 0">
  <div  v-for="service in services |filterBy filterData in 'status' | filterBy services_name in 'service.name'" track-by="$index">
    ...
    <orders :service="service" :user_to_show="service.get_user_add_serivecs"></orders>
  </div>
